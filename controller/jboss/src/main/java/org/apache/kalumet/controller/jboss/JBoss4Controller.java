 ...
 */
public class JBoss4Controller extends AbstractJ2EEApplicationServerController {
     ...
     */
    public JBoss4Controller(String url, String username, String password, String serverName, Boolean cluster) throws ControllerException {
    ...
    private void jdbcConnectionPoolWriteFile(File file, String name, String driver, int increment, int initial, int maximal, String user, String password, String url) throws ControllerException {
        ...
        if (StringUtils.containsIgnoreCase(driver, "xa")) {
            ...
            connectionPoolTemplate = new InputStreamReader(JBoss4Controller.class.getResourceAsStream("/jboss/template-xa-ds.xml"));
        } else {
            LOGGER.debug("Non XA connection pool detected");
            connectionPoolTemplate = new InputStreamReader(JBoss4Controller.class.getResourceAsStream("/jboss/template-ds.xml"));
        }
