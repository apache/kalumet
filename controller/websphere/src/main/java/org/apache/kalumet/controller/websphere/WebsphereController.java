...
public class WebsphereController extends AbstractJ2EEApplicationServerController {
   ...
   public void deployJNDIBinding(String name, String jndiName, String jndiAlias, String providerUrl) throws ControllerException {
      ...
      try {
         ...
         if (providerUrl != null && providerUrl.trim().length() > 0) {
            ...
            // create it
            configService.createConfigData(session, scope, "IndirectLookupNameSpaceBinding", "IndirectLookupNameSpaceBinding", attributes);
            // save the configuration
            configService.save(session, true);
            return;
         }
    ...
    */
   private void syncNodes() throws ControllerException {
    ...
    */
   private static List listNodes(AdminClient client) throws ControllerException {
    ...
    */
   private String getCellName(AdminClient client) throws Exception {
