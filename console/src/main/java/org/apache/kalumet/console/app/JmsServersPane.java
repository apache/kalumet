 ...
 */
public class JmsServersPane extends ContentPane {
    ...
    private ActionListener toggleActive = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            JMSServer jmsServer = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJMSServer(event.getActionCommand());
            if (jmsServer == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.warn.notfound"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
    ...
    private ActionListener toggleBlocker = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            JMSServer jmsServer = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJMSServer(event.getActionCommand());
            if (jmsServer == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.notfound"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
    ...
    private ActionListener delete = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // looking for the jms server object
            final JMSServer jmsServer = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJMSServer(event.getActionCommand());
            if (jmsServer == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.notfound"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJMSServers().remove(jmsServer);
                    // add a change event
    ...
    private ActionListener edit = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            if (KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().getComponent("jmsserverwindow_" + parent.getEnvironmentName() + "_" + (String) scopeField.getSelectedItem() + "_" + event.getActionCommand()) == null) {
                KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new JmsServerWindow(JmsServersPane.this, (String) scopeField.getSelectedItem(), event.getActionCommand()));
            }
        }
    };
    // create
    private ActionListener create = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new JmsServerWindow(JmsServersPane.this, (String) scopeField.getSelectedItem(), null));
        }
    };
    // copy
    ...
    private ActionListener status = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getLogPane().addInfo("JMS server " + jmsServerName + " status check in progress...", parent.getEnvironmentName());
    ...
    private ActionListener update = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    // add a message in the log pane and the journal
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("JMS server " + jmsServerName + " update in progress...", parent.getEnvironmentName());
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    ...
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("JMS server " + jmsServerName + " updated.", parent.getEnvironmentName());
    ...
    public JmsServersPane(EnvironmentWindow parent) {
        ...
        for (Iterator serversIterator = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServers().iterator(); serversIterator.hasNext(); ) {
    ...
    public void update() {
        ...
        // add the jms servers
        for (Iterator jmsServerIterator = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(applicationServerName).getJMSServers().iterator(); jmsServerIterator.hasNext(); ) {
