 ...
 */
public class ApplicationArchiveWindow extends WindowPane {

   private static String[] CLASSLOADER_ORDER = new String[] { Messages.getString("parentlast"), Messages.getString("parentfirst") };
   private static String[] CLASSLOADER_POLICY = new String[] { Messages.getString("single"), Messages.getString("multiple") };
   ...
   class StatusThread extends Thread {
       ...
       public void run() {
           try {
               ...
               boolean uptodate = client.check(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), archiveName);
               if (uptodate) {
                   message = "J2EE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " is up to date.";
               } else {
                   failure = true;
                   message = "J2EE appliction " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " is not up to date.";
               }
           } catch (Exception e) {
               failure = true;
               message = "J2EE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " status check failed: " + e.getMessage();
           } finally {
               ended = true;
           }
       }
   ...
   class UpdateThread extends Thread {
       ...
       public void run() {
           try {
               ...
               // call the web service
               ArchiveClient client = new ArchiveClient(agent.getHostname(), agent.getPort());
               client.update(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), archiveName, false);
           } catch (Exception e) {
               failure = true;
               message = "J2EE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " update failed: " + e.getMessage();
           } finally {
               ended = true;
           }
       }
      ...
      public void actionPerformed(ActionEvent event) {
         ...
         KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
             public void actionPerformed(ActionEvent event) {
                 ...
                 // add a change events
                 parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete JEE application archive " + archive.getName());
   ...
   private ActionListener apply = new ActionListener() {
      public void actionPerformed(ActionEvent event) {
         ...
         if (nameFieldValue == null || nameFieldValue.trim().length() < 1 || uriFieldValue == null || uriFieldValue.trim().length() < 1) {
             KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("archive.mandatory"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
             return;
         }
         ...
         if (archiveName == null || (archiveName != null && !archiveName.equals(nameFieldValue))) {
            if (parent.getParentPane().getApplication().getArchive(nameFieldValue) != null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("archive.exists"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
         }
         // add a change event
         ...
         if (archiveName == null) {
            try {
               ...
               parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add J2EE application archive " + archive.getName());
            } catch (Exception e) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("archive.exists"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
         ...
         setId("archivewindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_"
               + archive.getName());
   ...
   private ActionListener status = new ActionListener() {
       public void actionPerformed(ActionEvent event) {
           ...
           KalumetConsoleApplication.getApplication().getLogPane().addInfo("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " status check in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
           parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " status check requested.");
           ...
           KalumetConsoleApplication.getApplication().enqueueTask(KalumetConsoleApplication.getApplication().getTaskQueue(), new Runnable() {
               public void run() {
                   if (statusThread.ended) {
                       ...
                       parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add(statusThread.message);
                   } else {
       ...
       public void actionPerformed(ActionEvent event) {
           ...
           KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
               public void actionPerformed(ActionEvent event) {
                   ...
                   KalumetConsoleApplication.getApplication().getLogPane().addInfo("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " update in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                   parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " update requested.");
                       ...
                       public void run() {
                           if (updateThread.ended) {
                               if (updateThread.failure) {
                                   ...
                                   KalumetConsoleApplication.getApplication().getLogPane().addConfirm("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " updated.", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                                   parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("JEE application " + parent.getParentPane().getApplicationName() + " archive " + archiveName + " updated.");
                               }
                           } else {
                               KalumetConsoleApplication.getApplication().enqueueTask(KalumetConsoleApplication.getApplication().getTaskQueue(), this);
                           }
