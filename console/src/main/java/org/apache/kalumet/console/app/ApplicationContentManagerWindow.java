 ...
 */
public class ApplicationContentManagerWindow extends WindowPane {
    ...
    class UpdateThread extends Thread {
        ...
        public void run() {
            try {
                ...
                client.update(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), contentManagerName, false);
            } catch (Exception e) {
                failure = true;
                message = "J2EE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " update failed: " + e.getMessage();
            } finally {
                ended = true;
            }
        }
    ...
    private ActionListener refresh = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            ApplicationContentManagerWindow.this.contentManager = parent.getParentPane().getApplication().getContentManager(contentManagerName);
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    // add a change event
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete J2EE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManager.getName());
    ...
    private ActionListener apply = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // check fields
            if (nameFieldValue == null || nameFieldValue.trim().length() < 1 || classnameFieldValue == null || classnameFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("contentmanager.mandatory"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            // if the user change the content manager name, check if the new
            // content manager name doesn't already exist
            if (contentManagerName == null || (contentManagerName != null && !contentManagerName.equals(nameFieldValue))) {
                if (parent.getParentPane().getApplication().getContentManager(nameFieldValue) != null) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("contentmanager.exists"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            }
            // add a change event
            if (contentManagerName != null) {
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManager.getName());
            }
            ...
            if (contentManagerName == null) {
                try {
                    ...
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManager.getName());
                } catch (Exception e) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("contentmanager.exists"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            ...
            setId("contentmanagerwindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_"
    ...
    private ActionListener deleteProperty = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (property == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("property.notfound"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            // delete the property object
            contentManager.getProperties().remove(property);
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManager.getName() + " property " + property.getName());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    private ActionListener editProperty = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // get fields
            TextField propertyNameField = (TextField) ApplicationContentManagerWindow.this.getComponent("propertyname_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
                    + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_" + contentManagerName + "_" + event.getActionCommand());
            TextField propertyValueField = (TextField) ApplicationContentManagerWindow.this.getComponent("propertyvalue_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
                    + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_" + contentManagerName + "_" + event.getActionCommand());
            // get fields value
            String propertyNameFieldValue = propertyNameField.getText();
            String propertyValueFieldValue = propertyValueField.getText();
            // check fields
            if (propertyNameFieldValue == null || propertyNameFieldValue.trim().length() < 1 || propertyValueFieldValue == null || propertyValueFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("contentmanager.mandatory"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " property " + property.getName());
            // update the property
    ...
    private ActionListener createProperty = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // check fields
            if (newPropertyNameFieldValue == null || newPropertyNameFieldValue.trim().length() < 1 || newPropertyValueFieldValue == null || newPropertyValueFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("property.mandatory"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            try {
                ...
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("property.exists"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " property " + property.getName());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " update in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " update requested.");
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    ...
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " updated.", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("JEE application " + parent.getParentPane().getApplicationName() + " content manager " + contentManagerName + " updated.");
                                }
                            } else {
    ...
    public void update() {
        ...
        for (Iterator propertyIterator = contentManager.getProperties().iterator(); propertyIterator.hasNext(); ) {
            ...
            propertyNameField.setId("propertyname_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_"
                    + parent.getParentPane().getApplicationName() + "_" + contentManagerName + "_" + property.getName());
            ...
            propertyValueField.setId("propertyvalue_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_"
                    + parent.getParentPane().getApplicationName() + "_" + contentManagerName + "_" + property.getName());
