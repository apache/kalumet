 ...
 */
public class ConnectionPoolsPane extends ContentPane {
    ...
    class StatusThread extends Thread {
        ...
        public void run() {
            try {
                ...
                boolean uptodate = client.check(parent.getEnvironmentName(), (String) scopeField.getSelectedItem(), connectionPoolName);
                if (uptodate) {
    ...
    private ActionListener delete = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            final JDBCConnectionPool connectionPool = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJDBCConnectionPool(event.getActionCommand());
            if (connectionPool == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("connectionpool.notfound"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJDBCConnectionPools().remove(connectionPool);
    ...
    private ActionListener status = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getLogPane().addInfo("JDBC connection pool " + connectionPoolName + " status check in progress...", parent.getEnvironmentName());
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("JDBC connection pool " + connectionPoolName + " update in progress...");
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    ...
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("JDBC connection pool " + connectionPoolName + " updated.", parent.getEnvironmentName());
    ...
    private ActionListener edit = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            if (KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().getComponent("connectionpoolwindow_" + parent.getEnvironmentName() + "_" + (String) scopeField.getSelectedItem() + "_" + event.getActionCommand()) == null) {
                KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConnectionPoolWindow(ConnectionPoolsPane.this, (String) scopeField.getSelectedItem(), event.getActionCommand()));
            }
        }
    };
    // create
    private ActionListener create = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConnectionPoolWindow(ConnectionPoolsPane.this, (String) scopeField.getSelectedItem(), null));
        }
    };
    // toggle active
    private ActionListener toggleActive = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            JDBCConnectionPool connectionPool = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer((String) scopeField.getSelectedItem()).getJDBCConnectionPool(event.getActionCommand());
            if (connectionPool == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("connectionpool.notfound"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
    ...
    public void update() {
        ...
        for (Iterator jdbcConnectionPoolIterator = parent.getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(applicationServerName).getJDBCConnectionPools().iterator(); jdbcConnectionPoolIterator.hasNext(); ) {
