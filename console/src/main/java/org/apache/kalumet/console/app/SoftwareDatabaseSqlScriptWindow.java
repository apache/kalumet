 ...
 */
public class SoftwareDatabaseSqlScriptWindow extends WindowPane {
    ...
    private ActionListener apply = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (nameFieldValue == null || nameFieldValue.trim().length() < 1 || uriFieldValue == null || uriFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("sql.script.mandatory"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            if (name == null || (name != null && !name.equals(nameFieldValue))) {
                if (parent.getDatabase().getSqlScript(nameFieldValue) != null) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("sql.script.exists"), getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            }
            // add a change event
            if (name != null) {
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change SQL script " + sqlScript.getName());
            }
            ...
            if (name == null) {
                try {
                    ...
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add SQL script " + sqlScript.getName());
                } catch (Exception e) {
            ...
            setId("softwaresqlscriptwindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
    ...
    public ActionListener deleteMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete SQL script " + sqlScript.getName() + " mapping " + mapping.getKey());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    private ActionListener editMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // get fields
            TextField mappingKeyField = (TextField) SoftwareDatabaseSqlScriptWindow.this.getComponent("softwaremappingkey_"
            ...
            TextField mappingValueField = (TextField) SoftwareDatabaseSqlScriptWindow.this.getComponent("softwaremappingvalue_"
                    + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
                    + parent.getParentPane().getName() + "_" + parent.getName() + "_" + name + "_" + event.getActionCommand());
            // get fields value
            ...
            // add change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change SQL script " + sqlScript.getName() + " mapping " + mapping.getKey());
            // update the mapping
    ...
    private ActionListener createMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add SQL script " + sqlScript.getName() + " mapping " + mapping.getKey());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    public SoftwareDatabaseSqlScriptWindow(SoftwareDatabaseWindow parent, String name) {
        ...
        setId("softwaresqlscriptwindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getName() + "_" + parent.getName() + "_" + name);
    ...
    public void update() {
        ...
        for (Iterator mappingIterator = sqlScript.getMappings().iterator(); mappingIterator.hasNext(); ) {
            ...
            mappingKeyField.setId("softwaremappingkey_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getName() + "_" + parent.getName() + "_" + name + "_" + mapping.getKey());
            ...
            mappingValueField.setId("softwaremappingvalue_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getName() + "_" + parent.getName() + "_" + name + "_" + mapping.getKey());
