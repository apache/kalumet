 ...
 */
public class ApplicationDatabaseWindow extends WindowPane {
    ...
    class UpdateThread extends Thread {
        ...
        public void run() {
            try {
                ...
                client.update(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), databaseName, false);
            } catch (Exception e) {
                failure = true;
                message = "J2EE application " + parent.getParentPane().getApplicationName() + " database " + databaseName + " update failed: " + e.getMessage();
            } finally {
                ended = true;
            }
        }
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    // add a change event
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete database " + database.getName());
    ...
    private ActionListener apply = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (databaseName != null) {
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change database " + database.getName());
            }
            ...
            if (databaseName == null) {
                try {
                    ...
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add database " + database.getName());
                } catch (Exception e) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("database.exists"), getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            ...
            setId("databasewindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_"
                    + database.getName());
    ...
    public ActionListener toggleActiveSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (sqlScript.isActive()) {
                ...
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Disable SQL script " + sqlScript.getName());
            } else {
                sqlScript.setActive(true);
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Enable SQL script " + sqlScript.getName());
            }
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
    ...
    public ActionListener toggleBlockerSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (sqlScript.isBlocker()) {
                ...
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Set not blocker for SQL script " + sqlScript.getName());
            } else {
                sqlScript.setBlocker(true);
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Set blocker for SQL script " + sqlScript.getName());
            }
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
    ...
    public ActionListener toggleForceSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (sqlScript.isForce()) {
                ...
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Set not force for SQL script " + sqlScript.getName());
            } else {
                sqlScript.setForce(true);
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Set force for SQL script " + sqlScript.getName());
            }
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
    ...
    private ActionListener deleteSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete SQL script " + sqlScript.getName());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    private ActionListener editSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            if (KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().getComponent(
                    "sqlscriptwindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName()
                            + "_" + databaseName + "_" + event.getActionCommand()) == null) {
                KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ApplicationDatabaseSqlScriptWindow(ApplicationDatabaseWindow.this, event.getActionCommand()));
            }
        }
    };
    // create sql script
    private ActionListener createSqlScript = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ApplicationDatabaseSqlScriptWindow(ApplicationDatabaseWindow.this, null));
        }
    };
    // copy
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("J2EE application " + parent.getParentPane().getApplicationName() + " database " + databaseName + " update in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("J2EE application " + parent.getParentPane().getApplicationName() + " database " + databaseName + " update in progress ...");
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    ...
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("J2EE application " + parent.getParentPane().getApplicationName() + " database " + databaseName + " updated.", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("J2EE application " + parent.getParentPane().getApplicationName() + " database " + databaseName + " updated.");
                                }
                            } else {
    ...
    public void update() {
        ...
        try {
            ...
            KalumetConsoleApplication.getApplication().getLogPane().addError(Messages.getString("db.read") + ": " + e.getMessage(), getEnvironmentWindow().getEnvironmentName());
        }
        ...
        for (Iterator connectionPoolIterator = getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(parent.getParentPane().getServerName()).getJDBCConnectionPools().iterator(); connectionPoolIterator.hasNext(); ) {
