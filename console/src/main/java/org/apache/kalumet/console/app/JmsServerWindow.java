 ...
 * JMS server window.
 */
public class JmsServerWindow extends WindowPane {
    ...
    class StatusThread extends Thread {
        ...
        public void run() {
            try {
                ...
                boolean uptodate = client.check(parent.getEnvironmentWindow().getEnvironmentName(), serverName, jmsServerName);
                if (uptodate) {
    ...
    private ActionListener refresh = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            jmsServer = parent.getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(serverName).getJMSServer(jmsServerName);
            if (jmsServer == null) {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    parent.getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(serverName).getJMSServers().remove(jmsServer);
                    // add a change event
    ...
    private ActionListener apply = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (nameFieldValue == null || nameFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.mandatory"), getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            if (jmsServerName == null || (jmsServerName != null && !jmsServerName.equals(nameFieldValue))) {
                if (parent.getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(serverName).getJMSServer(nameFieldValue) != null) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.exists"), getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            }
            // add a change event
            ...
            if (jmsServerName == null) {
                try {
                    parent.getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(serverName).addJMSServer(jmsServer);
                    parent.getEnvironmentWindow().getChangeEvents().add("Add JMS server (name [ " + nameFieldValue + " ]) in the J2EE application server " + serverName);
                } catch (Exception e) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("jmsserver.exists"), getEnvironmentWindow().getEnvironmentName());
                    return;
                }
            ...
            setId("jmsserverwindow_" + parent.getEnvironmentWindow().getEnvironmentName() + "_" + serverName + "_" + jmsServer.getName());
    ...
    private ActionListener status = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getLogPane().addInfo("JMS server " + jmsServerName + " status check in progress...", parent.getEnvironmentWindow().getEnvironmentName());
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("JMS server " + jmsServerName + " update in progress...", parent.getEnvironmentWindow().getEnvironmentName());
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    ...
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("JMS server " + jmsServerName + " updated.", parent.getEnvironmentWindow().getEnvironmentName());
    ...
    public JmsServerWindow(JmsServersPane parent, String applicationServerName, String jmsServerName) {
        ...
        this.jmsServer = parent.getEnvironmentWindow().getEnvironment().getJ2EEApplicationServers().getJ2EEApplicationServer(serverName).getJMSServer(jmsServerName);
        ...
        setId("jmsserverwindow_" + parent.getEnvironmentWindow().getEnvironmentName() + "_" + serverName + "_" + jmsServerName);
