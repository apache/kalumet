 ...
 * @author onofre
 */
public class AdminUsersWindow extends WindowPane {
   ...
   private ActionListener refreshActionListener = new ActionListener() {
      public void actionPerformed(ActionEvent event) {
         ...
         update();
         KalumetConsoleApplication.getApplication().getLogPane().addInfo(Messages.getString("users") + " " + Messages.getString("reloaded"));
      }
   };
   ...
   private ActionListener editActionListener = new ActionListener() {
      public void actionPerformed(ActionEvent event) {
         if(KalumetConsoleApplication.getApplication().getDefaultWindow().getComponent("user_" + event.getActionCommand()) == null) {
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new AdminUserWindow(AdminUsersWindow.this, event.getActionCommand()));
         }
      }
   };
   // add action listener
   private ActionListener addActionListener = new ActionListener() {
      public void actionPerformed(ActionEvent event) {
         KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new AdminUserWindow(AdminUsersWindow.this, null));
      }
   };
   ...
   public AdminUsersWindow() {
      ...
      if(!KalumetConsoleApplication.getApplication().getUserid().equals("admin")) {
          KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("users.warn.restricted"));
          this.userClose();
          return;
      }
