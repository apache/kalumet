 ...
 */
public class ApplicationConfigurationFileWindow extends WindowPane {
    ...
    class StatusThread extends Thread {
        ...
        public void run() {
            try {
                ...
                Agent agent = kalumet.getAgent(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironment().getAgent());
                if (agent == null) {
                    throw new IllegalArgumentException("agent not found.");
                }
                // call the webservice
                ConfigurationFileClient client = new ConfigurationFileClient(agent.getHostname(), agent.getPort());
                boolean uptodate = client.check(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), configurationFileName);
                if (uptodate) {
                    message = "J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " is up to date.";
                } else {
                    failure = true;
                    message = "J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " is not up to date.";
                }
            } catch (Exception e) {
                failure = true;
                message = "J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " status check failed: " + e.getMessage();
            } finally {
                ended = true;
            }
        }
    ...
    class UpdateThread extends Thread {
        ...
        public void run() {
            try {
                ...
                // call the webservice
                ConfigurationFileClient client = new ConfigurationFileClient(agent.getHostname(), agent.getPort());
                client.update(parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName(), parent.getParentPane().getServerName(), parent.getParentPane().getApplicationName(), configurationFileName, false);
            } catch (Exception e) {
                failure = true;
                message = "J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " update failed: " + e.getMessage();
            } finally {
                ended = true;
            }
        }
    ...
    private ActionListener refresh = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            ApplicationConfigurationFileWindow.this.configurationFile = parent.getParentPane().getApplication().getConfigurationFile(configurationFileName);
    ...
    private ActionListener delete = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (!parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironment().getLock().equals(KalumetConsoleApplication.getApplication().getUserid())) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("environment.locked"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            if (!parent.getParentPane().getParentPane().getEnvironmentWindow().adminPermission
                ...
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("action.restricted"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    // add a change event
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete J2EE application configuration file " + configurationFile.getName());
    ...
    private ActionListener apply = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (nameFieldValue == null || nameFieldValue.trim().length() < 1 || uriFieldValue == null || uriFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.mandatory"));
                return;
            }
            // if the user change the configuration file name, check if the new
            // name doesn't already exist
            if (configurationFileName == null || (configurationFileName != null && !configurationFileName.equals(nameFieldValue))) {
                if (parent.getParentPane().getApplication().getConfigurationFile(nameFieldValue) != null) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.exists"));
                    return;
                }
            }
            // add a change event
            if (configurationFileName != null) {
                parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change J2EE application configuration file " + configurationFile.getName());
            }
            ...
            if (configurationFileName == null) {
                try {
                    ...
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add J2EE application configuration file " + configurationFile.getName());
                } catch (Exception e) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.exists"));
                    return;
                }
            ...
            setId("configurationfilewindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName()
    ...
    private ActionListener status = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (parent.getParentPane().getParentPane().getEnvironmentWindow().isUpdated()) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("environment.notsaved"), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                return;
            }
            // add a message into the log pane and the journal
            KalumetConsoleApplication.getApplication().getLogPane().addInfo("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " status check in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " status check requested.");
                ...
                public void run() {
                    if (statusThread.ended) {
                        if (statusThread.failure) {
                            KalumetConsoleApplication.getApplication().getLogPane().addWarning(statusThread.message, parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                        } else {
                            KalumetConsoleApplication.getApplication().getLogPane().addInfo(statusThread.message, parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                        }
                    } else {
    ...
    private ActionListener update = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            KalumetConsoleApplication.getApplication().getDefaultWindow().getContent().add(new ConfirmWindow(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    // add a message into the log pane and the journal
                    KalumetConsoleApplication.getApplication().getLogPane().addInfo("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " update in progress...", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " update requested.");
                        ...
                        public void run() {
                            if (updateThread.ended) {
                                if (updateThread.failure) {
                                    KalumetConsoleApplication.getApplication().getLogPane().addError(updateThread.message, parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add(updateThread.message);
                                } else {
                                    KalumetConsoleApplication.getApplication().getLogPane().addConfirm("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " updated.", parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
                                    parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("J2EE application " + parent.getParentPane().getApplicationName() + " configuration file " + configurationFileName + " updated.");
                                }
                            } else {
                                KalumetConsoleApplication.getApplication().enqueueTask(KalumetConsoleApplication.getApplication().getTaskQueue(), this);
                            }
    ...
    private ActionListener deleteMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            if (mapping == null) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.mapping.notfound"));
                return;
            }
            // delete the mapping object
            configurationFile.getMappings().remove(mapping);
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Delete J2EE application configuration file " + configurationFile.getName() + " mapping " + mapping.getKey());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    private ActionListener editMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // get fields
            TextField keyField = (TextField) ApplicationConfigurationFileWindow.this.getComponent("configurationfilemappingkey_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
                    + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_" + configurationFileName + "_" + event.getActionCommand());
            TextField valueField = (TextField) ApplicationConfigurationFileWindow.this.getComponent("configurationfilemappingvalue_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_"
                    + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_" + configurationFileName + "_" + event.getActionCommand());
            // get fields value
            ...
            if (keyFieldValue == null || keyFieldValue.trim().length() < 1) {
                KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.mapping.mandatory"));
                return;
            }
            ...
            if (!keyFieldValue.equals(event.getActionCommand())) {
                if (configurationFile.getMapping(keyFieldValue) != null) {
                    KalumetConsoleApplication.getApplication().getLogPane().addWarning(Messages.getString("configurationfile.warn.mapping.exists"));
                    return;
                }
            }
            // looking for the mapping object
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Change J2EE application configuration file " + configurationFile.getName() + " mapping " + mapping.getKey());
            // update the mapping
    ...
    private ActionListener createMapping = new ActionListener() {
        public void actionPerformed(ActionEvent event) {
            ...
            // add a change event
            parent.getParentPane().getParentPane().getEnvironmentWindow().getChangeEvents().add("Add J2EE application configuration file " + configurationFile.getName() + " mapping " + mapping.getKey());
            // change the updated flag
            parent.getParentPane().getParentPane().getEnvironmentWindow().setUpdated(true);
            // update the journal log tab pane
            parent.getParentPane().getParentPane().getEnvironmentWindow().updateJournalPane();
    ...
    public ApplicationConfigurationFileWindow(ApplicationConfigurationFilesPane parent, String configurationFileName) {
        ...
        setId("configurationfilewindow_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_" + parent.getParentPane().getApplicationName() + "_"
    ...
    public void update() {
        ...
        try {
            ...
            KalumetConsoleApplication.getApplication().getLogPane().addError(Messages.getString("db.read") + ": " + e.getMessage(), parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName());
        }
        ...
        for (Iterator mappingIterator = configurationFile.getMappings().iterator(); mappingIterator.hasNext(); ) {
            ...
            mappingKeyField.setId("configurationfilemappingkey_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_"
                    + parent.getParentPane().getApplicationName() + "_" + configurationFileName + "_" + mapping.getKey());
            ...
            mappingValueField.setId("configurationfilemappingvalue_" + parent.getParentPane().getParentPane().getEnvironmentWindow().getEnvironmentName() + "_" + parent.getParentPane().getServerName() + "_"
                    + parent.getParentPane().getApplicationName() + "_" + configurationFileName + "_" + mapping.getKey());
