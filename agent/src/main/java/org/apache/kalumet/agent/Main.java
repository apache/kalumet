...
public final class Main {
    ...
    public final static void main(String[] args) {
        ...
        Option config = OptionBuilder.withArgName("config").hasArg().withDescription("The location URL (local: or http:) to the Kalumet configuration (e.g. http://hostname/kalumet/ConfigurationWrapper)").isRequired()
                .create("config");
        options.addOption(config);
        Option agentid = OptionBuilder.withArgName("id").hasArg().withDescription("The Kalumet agent identification as defined in the configuration").isRequired().create("id");
