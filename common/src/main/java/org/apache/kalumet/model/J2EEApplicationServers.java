 ...
 */
public class J2EEApplicationServers
  implements Serializable, Cloneable
{
   ...
   */
  public void addJ2EEApplicationServer( J2EEApplicationServer j2EEApplicationServer )
  ...
  {
    for ( Iterator applicationServerIterator = this.getJ2EEApplicationServers().iterator();
    ...
    throws CloneNotSupportedException
  {
    ...
    for ( Iterator applicationServerIterator = this.j2eeApplicationServers.iterator();
          applicationServerIterator.hasNext(); )
    {
      J2EEApplicationServer j2EEApplicationServer = (J2EEApplicationServer) applicationServerIterator.next();
