...
public class KalumetTest {
    ...
    public void testJ2EEApplicationServerUnmarshalling() {
        ...
        J2EEApplicationServer applicationServer = kalumetModel.getEnvironment("test_auto").getJ2EEApplicationServers().getJ2EEApplicationServer("as_test");
    ...
    public void testJDBCConnectionPoolUnmarshalling() {
        ...
        JDBCConnectionPool connectionPool = kalumetModel.getEnvironment("test_auto").getJ2EEApplicationServers().getJ2EEApplicationServer("as_test").getJDBCConnectionPool("test");
    ...
    public void testJDBCDataSourceUnmarshalling() {
        ...
        JDBCDataSource dataSource = kalumetModel.getEnvironment("test_auto").getJ2EEApplicationServers().getJ2EEApplicationServer("as_test").getJDBCDataSource("test");
    ...
    public void testSoftwareUpdatePlanConfigurationFileUnmarshalling() {
        ...
        ConfigurationFile configurationFile = kalumetModel.getEnvironment("test_auto").getSoftware("test").getConfigurationFile("configurationfile_test");
    ...
    public void testSoftwareUpdatePlanDatabaseSqlScriptUnmarshaling() {
        LOGGER.info("Get Kalumet environment test_auto test software db_test database update plan sqlscript_test SQL script.");
        SqlScript sqlScript = kalumetModel.getEnvironment("test_auto").getSoftware("test").getDatabase("db_test").getSqlScript("sqlscript_test");
    ...
    @Test
    public void testKalumetMarshalling() throws Exception {
    ...
    @Test
    public void testKalumetUnmarshalling() throws Exception {
