...
public class FileManipulatorTest {
    ...
    @Test
    public void testProtocolPrefix() throws Exception {
        String uri = "http://uri";
    ...
    @Test
    public void testVFSFormatting() throws Exception {
        String uri = FileManipulator.format("http://uri/archive.tar.gz") + "!/lib";
        assertEquals("tgz:http://uri/archive.tar.gz!/lib", uri);
    }

    @Test
    public void testContentCompare() throws Exception {
        assertEquals(true, fileManipulator.contentEquals("https://svn.apache.org/repos/asf/incubator/kalumet/trunk/LICENSE",
    ...
    public void testExists() throws Exception {
        ...
        assertEquals(false, fileManipulator.exists("https://svn.apache.org/repos/asf/incubator/kalumet/trunk/NOT_FOUND"));
    }
